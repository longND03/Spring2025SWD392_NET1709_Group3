        ...
        <div className="bg-white p-6 rounded-lg shadow-lg">
          ...
          <div className="space-y-4">
            ...
            <div className="mt-8 p-6 bg-gray-50 rounded-lg">
              ...
              <p className="mb-6">
                Please scan the QR code below and transfer the exact amount of ${orderData.totalAmount.toFixed(2)}.
                Use the following description for your transfer: <span className="font-semibold">ORDER_{orderData.id}</span>
              </p>
